CLASS lsc_zrap110_r_traveltp_007 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
    METHODS adjust_numbers REDEFINITION.
ENDCLASS.

CLASS lsc_zrap110_r_traveltp_007 IMPLEMENTATION.
  METHOD adjust_numbers.
    ...
    IF mapped-booking IS NOT INITIAL.
      ...
      LOOP AT mapped-booking INTO DATA(mapped_booking) GROUP BY mapped_booking-TravelID.
        SELECT MAX( booking_id ) FROM zrap110_abook007 WHERE travel_id = @mapped_booking-TravelID INTO @DATA(max_booking_id) .
...
**************************************************************************
  METHOD setInitialTravelValues.
    ...
    DATA: update TYPE TABLE FOR UPDATE zrap110_r_traveltp_007\\Travel.

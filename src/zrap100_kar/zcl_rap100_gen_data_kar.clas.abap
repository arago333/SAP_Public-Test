CLASS zcl_rap100_gen_data_kar DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_KAR IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'KAR',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

    DELETE FROM zrap100_atravkar.

    INSERT zrap100_atravkar  FROM (
           SELECT
